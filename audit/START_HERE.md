...
| FIXED (code in, awaiting founder live-verify) | 44 |
| WONTFIX | 1 |
| **TODO (your job)** | **443** |

By severity of the remaining TODO: **CRITICAL 112 · HIGH 193 · MEDIUM 129 · LOW 9** (re-counted directly from the register after the 137 closed).
