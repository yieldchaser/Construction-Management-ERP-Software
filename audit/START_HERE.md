...
| FIXED (code in, awaiting founder live-verify) | 56 |
| WONTFIX | 1 |
| **TODO (your job)** | **431** |

By severity of the remaining TODO: **CRITICAL 105 · HIGH 189 · MEDIUM 128 · LOW 9** (re-counted directly from the register after the 149 closed).
