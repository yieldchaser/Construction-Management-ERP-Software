...
| FIXED (code in, awaiting founder live-verify) | 69 |
| WONTFIX | 1 |
| **TODO (your job)** | **418** |

By severity of the remaining TODO: **CRITICAL 102 · HIGH 188 · MEDIUM 126 · LOW 2** (re-counted directly from the register after the 162 closed).
