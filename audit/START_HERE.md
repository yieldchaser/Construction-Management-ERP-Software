...
| FIXED (code in, awaiting founder live-verify) | 67 |
| WONTFIX | 1 |
| **TODO (your job)** | **420** |

By severity of the remaining TODO: **CRITICAL 102 · HIGH 188 · MEDIUM 126 · LOW 4** (re-counted directly from the register after the 160 closed).
