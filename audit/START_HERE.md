...
| FIXED (code in, awaiting founder live-verify) | 48 |
| WONTFIX | 1 |
| **TODO (your job)** | **439** |

By severity of the remaining TODO: **CRITICAL 111 · HIGH 190 · MEDIUM 129 · LOW 9** (re-counted directly from the register after the 141 closed).
