...
export default function VerdictCards({ verdict }: { verdict: ComparisonVerdict[] }) {
  return (
    <div className="rounded-2xl border border-alx-outline-variant/30 bg-alx-surface-container-lowest shadow-xl shadow-alx-on-surface/5 overflow-hidden flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-alx-outline-variant/25">
      {verdict.map((v, idx) => (
