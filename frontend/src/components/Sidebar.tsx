...
export default function Sidebar({ onShowToast }: { onShowToast?: (msg: string) => void }) {
    ...
    const fetchCompany = async () => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          setCompanyName(data.name || "Demo Company Ltd");
  ...
  const navItems = [
    ...
    },
    {
      ...
      action: () => localToast("Logs cleared successfully!"),
    },
  ];
    ...
    <aside className="w-64 border-r border-border-custom bg-sidebar flex flex-col justify-between h-full shrink-0">
      <div className="flex flex-col overflow-y-auto flex-1">
        ...
        <div className="p-5 flex items-center gap-3 border-b border-border-custom">
          ...
          <div className="min-w-0">
            ...
            <span className="text-[11px] text-muted uppercase tracking-wider font-medium">Admin Panel</span>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-border-custom bg-background/25">
        ...
        <div className="flex items-center gap-2.5 mb-4">
          ...
          <div className="min-w-0">
            <div className="text-xs font-semibold text-foreground truncate w-40">Demo Manager</div>
            <div className="text-[10px] text-muted">Active Tenant Context</div>
          </div>
        </div>
