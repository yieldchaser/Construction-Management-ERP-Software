...
// HTML we already render. If a post happens to carry no headings, the
// sidebar falls back to related posts instead of showing an empty TOC.
// ---------------------------------------------------------------------------
interface TocEntry {
  level: 2 | 3;
  text: string;
    ...
    <MarketingShell>
      <div className="max-w-6xl mx-auto px-6 pt-4 pb-24">
        ...
        <nav className="alx-scroll-fade flex items-center gap-1.5 font-uilabel text-[11px] uppercase tracking-widest text-alx-outline mb-6">
          ...
          <span className="text-alx-outline-variant">/</span>
          <span className="text-alx-primary font-bold">{category}</span>
        </nav>
          ...
          <aside className="lg:col-span-4">
            <div className="alx-scroll-fade lg:sticky lg:top-28 space-y-6">
              ...
              >
                ...
                <h3 className="font-headline text-lg font-extrabold mb-2">Build Smarter</h3>
                <p className="mb-4 font-body text-xs leading-relaxed text-white/85">
                  Get weekly construction-tech insights from the SiteFlow editorial team.
                </p>
