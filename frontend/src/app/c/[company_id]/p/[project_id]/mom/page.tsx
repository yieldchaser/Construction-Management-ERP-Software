    ...
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      ...
      <aside className="w-56 border-r border-border-custom bg-card flex flex-col shrink-0">
        <div className="p-5 border-b border-border-custom flex items-center gap-2.5">
          <div className="h-7 w-7 rounded-lg bg-gradient-to-tr bg-primary flex items-center justify-center font-bold text-white text-xs">M</div>
          <span className="font-bold text-white text-sm">Meetings (MOM)</span>
        </div>
        <nav className="p-3 flex-1 space-y-1">
          <button
            className="w-full text-left flex items-center gap-2 px-3 py-2 text-xs font-semibold rounded-lg bg-primary/10 text-white shadow-sm"
          >
