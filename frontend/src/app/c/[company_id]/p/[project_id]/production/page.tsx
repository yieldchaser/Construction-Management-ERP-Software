      ...
      <aside className="w-72 shrink-0 border-r border-border-custom bg-card">
        <div className="flex items-center gap-3 border-b border-border-custom p-6">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase tracking-[0.24em] text-muted">Production Management</div>
          </div>
        </div>
        ...
        <div className="px-4 pb-4 space-y-3">
          <div className="rounded-lg border border-border-custom bg-elevated p-4">
            <div className="text-[10px] uppercase tracking-[0.24em] text-muted">Project Scope</div>
          ...
          <div className="rounded-lg border border-border-custom bg-elevated p-4">
            <div className="text-[10px] uppercase tracking-[0.24em] text-muted">Status Watch</div>
              ...
              <button
                ...
                className={`rounded-full px-4 py-2 text-xs font-semibold transition-all ${
                  tab === item.key
                    ...
                    : "bg-white/[0.03] text-muted hover:bg-primary/10 hover:text-foreground"
                }`}
              >
                {item.label}
              </button>
